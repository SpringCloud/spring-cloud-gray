<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="Service Id" prop="serviceId" width="100px" align="center">
      ...
      <el-table-column label="实例数" width="100px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.instanceNumber }}</span>
        </template>
      </el-table-column>
      <el-table-column label="灰度数" width="100px" align="center">
        <template slot-scope="scope">
