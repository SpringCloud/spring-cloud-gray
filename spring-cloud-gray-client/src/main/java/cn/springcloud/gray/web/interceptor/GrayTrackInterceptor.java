...
/**
 * @see {@link cn.springcloud.gray.web.GrayTrackFilter}
 */
@Deprecated
public class GrayTrackInterceptor extends HandlerInterceptorAdapter {
    ...
    public GrayTrackInterceptor(RequestLocalStorage requestLocalStorage, List<GrayInfoTracker<GrayHttpTrackInfo, HttpServletRequest>> trackors) {
